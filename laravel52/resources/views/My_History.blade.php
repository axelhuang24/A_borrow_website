				...
				@foreach($Articles as $article)
					@if($count%2 == 0)
						<tr class="success">
							...
							<td>
								@if ($article -> status == 0)
									<a href="{{route('delete', ['object_id' => $article -> object_id])}}" class="btn btn-primary" role="button">Remove it now</a>
								@else
									<a href="#" class="btn btn-primary" role="button">Remove it later</a>
								@endif
							</td>
						</tr>
						<?php $count=$count + 1; ?>
